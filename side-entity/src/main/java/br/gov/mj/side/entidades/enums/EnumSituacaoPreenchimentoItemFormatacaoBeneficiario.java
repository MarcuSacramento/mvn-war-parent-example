...
public enum EnumSituacaoPreenchimentoItemFormatacaoBeneficiario implements BaseEnum<String> {
    ...
    private EnumSituacaoPreenchimentoItemFormatacaoBeneficiario(String valor, String descricao) {
        this.valor = valor;
