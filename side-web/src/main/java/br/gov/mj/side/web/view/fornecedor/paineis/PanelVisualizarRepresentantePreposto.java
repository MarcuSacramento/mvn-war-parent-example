...
public class PanelVisualizarRepresentantePreposto extends Panel {
    ...
    public PanelVisualizarRepresentantePreposto(String id, List<PessoaEntidade> lista, List<PessoaEntidade> segundaLista, EnumTipoPessoa tipoPessoa, ContratoPage2 pagina) {
        super(id);
