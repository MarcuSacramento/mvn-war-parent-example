...
public class InscricaoListClassificacaoReportBuilder extends ReportBuilder<InscricaoPrograma> {

    private static final String REPORT_PATH = "reports/lista_classificacao.jasper";
    ...
    public InscricaoListClassificacaoReportBuilder(String titulo) {
