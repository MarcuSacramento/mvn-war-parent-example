...
public class ConsultaPublicaPesquisaPage extends TemplateExternalPage {
    ...
    public ConsultaPublicaPesquisaPage(final PageParameters pageParameters) {
    ...
    private void initComponents() {
        ...
        if (usuarioLogado != null) {
            ...
            dashboardPessoasPanel.setVisible(false);
            this.habilitarBotaoVoltar = true;
        }
    ...
    private InfraDropDownChoice<EmendaParlamentar> newDropDownEmendaParlamentar() {
        InfraDropDownChoice<EmendaParlamentar> dropDownChoice = componentFactory.newDropDownChoice("emendaParlamentar", "Emenda Parlamentar", false, "id", "nomeEmendaParlamentar", null, listaEmendas, null);
        dropDownChoice.setNullValid(true);
        return dropDownChoice;
    ...
    private AjaxCheckBox getCheckInscrito(Item<Programa> item) {
        ...
        AjaxCheckBox checkInscrito = new AjaxCheckBox("checkPrivado", new Model<Boolean>(true)) {
        ...
        checkInscrito.setOutputMarkupId(true);
        checkInscrito.setEnabled(false);
        checkInscrito.setVisible(mostrarCheck);

        return checkInscrito;
    }
    ...
    private void inscrever(Item<Programa> item) {
        ...
        // setResponsePage(new
        // InscricaoProgramaPage(parameters,item.getModelObject(),this));
    }
