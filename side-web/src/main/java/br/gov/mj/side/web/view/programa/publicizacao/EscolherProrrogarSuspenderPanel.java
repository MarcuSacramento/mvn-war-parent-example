...
public class EscolherProrrogarSuspenderPanel extends Panel {
    ...
    public EscolherProrrogarSuspenderPanel(String id,ProgramaHistoricoPublicizacao programaHistorico) {
        super(id);
    ...
    private class PanelAnalise extends WebMarkupContainer {
        ...
        public PanelAnalise(String id) {
            ...
            InfraLocalDateTextField date = componentFactory.newDateTextFieldWithDatePicker("dataFinalAnalise", "Período para análise das propostas Final", true, new PropertyModel<LocalDate>(programaHistorico, "dataFinalAnalise"), DD_MM_YYYY, PT_BR);
    ...
    private InfraLocalDateTextField newDateTextFieldDataInicioProposta() {
        InfraLocalDateTextField dataInicioProposta = componentFactory.newDateTextFieldWithDatePicker("dataInicialProposta", "Período para propostas Início", true, new PropertyModel<LocalDate>(this, "programaHistorico.dataInicialProposta"), DD_MM_YYYY, PT_BR);
    ...
    private InfraLocalDateTextField newDateTextFieldDataFimProposta() {
        dataFimProposta = componentFactory.newDateTextFieldWithDatePicker("dataFinalProposta", "Período para propostas Final", true, new PropertyModel<LocalDate>(this, "programaHistorico.dataFinalProposta"), DD_MM_YYYY, PT_BR);
        dataFimProposta.setEnabled(false);
        return dataFimProposta;
    }

    private InfraLocalDateTextField newDateTextFieldDataInicioAnalise() {
        dataInicioAnalise = componentFactory.newDateTextFieldWithDatePicker("dataInicialAnalise", "Período para análise das propostas Início", true, new PropertyModel<LocalDate>(this, "programaHistorico.dataInicialAnalise"), DD_MM_YYYY, PT_BR);
    ...
    private InfraDropDownChoice<EnumTipoPrograma> newDropDownTipoPrograma() {
        InfraDropDownChoice<EnumTipoPrograma> dropDown = componentFactory.newDropDownChoice("tipoPrograma", "Tipo de Programa", false, "valor", "descricao", new PropertyModel<EnumTipoPrograma>(this, "programaHistorico.tipoPrograma"), Arrays.asList(EnumTipoPrograma.values()), null);
