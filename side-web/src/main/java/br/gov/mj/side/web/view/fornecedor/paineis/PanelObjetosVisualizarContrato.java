...
public class PanelObjetosVisualizarContrato extends Panel {
	...
	public PanelObjetosVisualizarContrato(String id, Page backPage, Contrato contrato, List<AgrupamentoLicitacao> agrupamentoItem, Boolean cadastroNovo) {
		super(id);
